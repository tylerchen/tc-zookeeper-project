...
public class SqlMapper {
    ...
    private class MSUtils {
         ...
         * @return
         */
        private String newMsId(String sql, Class<?> parameterType, SqlCommandType sqlCommandType) {
            return new StringBuilder(sqlCommandType.toString())
                    .append('.').append(sql.length())
                    .append('-').append(sql.hashCode())
                    .append('-').append(parameterType == null ? "NULL" : parameterType.getSimpleName())
                    .toString();
        }
        ...
        private String select(String sql, Class<?> resultType) {
            return selectDynamic(sql, null, resultType);
        }
